...
namespace OptimusPrimeWeb.Controllers
{
    public class ShellSortController : Controller
    {
        ...
        public ShellSortController(IUserInputValidateConsumer userInputValidateConsumer, IUserInputServices userInputServices)
        {
        ...
        public async Task<IActionResult> Sort(SortUserInput userInput)
        {
            ...
            {
                var sortedResults = await _userInputServices.ShellSort(userInput);
