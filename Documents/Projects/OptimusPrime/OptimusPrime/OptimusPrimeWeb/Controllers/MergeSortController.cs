...
namespace OptimusPrimeWeb.Controllers
{
    public class MergeSortController : Controller
    {
        ...
        public MergeSortController(IUserInputValidateConsumer userInputValidateConsumer, IUserInputServices userInputServices)
        {
        ...
        public async Task<IActionResult> Sort(SortUserInput userInput)
        {
            ...
            {
                var sortedResults = await _userInputServices.MergeSort(userInput);
